    ...
    for imind, impath in enumerate(imlist):
        ...
        for boxind in range(0, min(rpn_conf.nms_topN_post, aboxes.shape[0])):
            ...
            if score >= 0.75:
                ...
                ry3d, alpha = compute_orientaion(P2, x2, x1, alpha)

                # compute and update translation, (x, y, z)
                x3d, y3d, z3d = translation_constraints(P2, x2, x1, y2, y1, l3d, w3d, h3d, alpha)
...
def compute_orientaion(P2, xmax, xmin, alpha):
    x = (xmax + xmin) / 2
...
def translation_constraints(P2, xmax, xmin, ymax, ymin, l, w, h, rot_local):
    ...
    xmin_candi, xmax_candi, ymin_candi, ymax_candi = box3d_candidate(l, w, h, rot_local, soft_range=8)
...
def box3d_candidate(l, w, h, rot_local, soft_range):
