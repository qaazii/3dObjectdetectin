...
class RPN(nn.Module):
    ...
    def __init__(self, phase, base, bbox_base, conf):
        super(RPN, self).__init__()

        self.base = base
        # add bbox base
        self.bbox_base = bbox_base
        ...
        self.prop_feats = nn.Sequential(
            LocalConv2d(self.base.layer3[-1].conv3.out_channels, 512, 3, padding=1),
...
def build(conf, phase='train'):
    ...
    bbox_base = models.vgg19(pretrained=train)
    ...
    rpn_net = RPN(phase, densenet121, bbox_base, conf)
